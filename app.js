...
// this here refers to the object created by the constructor on line 153 and will return the information held inside of it
// 2. What is "this" when joe.scopeArrow() is invoked?
// I don't think its anything? The assignment said you can't use them in arrow functions, and the .scopeArrow seems to be trying to combine a constructor and an arrow function. I think this will lead to problems because this isn't reset between uses when playing with arrow functions. Gee, I hope these are explained in class better
// 3. Explain why "this" is different when an arrow function is used.
// arrow functions don't rebind this when used inside of other fucntions